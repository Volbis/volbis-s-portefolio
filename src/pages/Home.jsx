    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          className="inline-flex items-center mt-24 sm:mt-32 lg:mt-40 gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-3 mb-8 sm:mb-12 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full text-xs sm:text-sm text-gray-300 relative overflow-hidden cursor-pointer transition-transform duration-300 hover:scale-105"
          style={{
        ...
        {/* Titre */}
          ...
          >
            ...
            transition={{ delay: 1.2, duration: 0.8 }}
              ...
              <motion.div 
                variants={itemVariants}
                className="flex flex-col sm:flex-row mx-4 sm:mx-0 gap-3 sm:gap-4 justify-center items-center mb-16 sm:mb-20"
              >
                <motion.button
            ...
            <span className="relative z-10 flex items-center justify-center gap-2">
              ...
              >
                ...
                <div className="relative">
                  <div 
                    className="w-6 h-12 border-2 border-gray-300 group-hover:border-white rounded-full flex justify-center transition-colors duration-300"
                    style={{ background: 'transparent' }}
                  >
                    <motion.div
                      className="w-3 h-3 bg-gray-300 group-hover:bg-white rounded-full mt-1.5 transition-colors duration-300"
                      animate={{
                        opacity: [0.3, 1, 0.3],
                        y: [-6, 6, -6]
                      }}
                ...
                <motion.span 
                  className="text-xs text-gray-500 mt-3 group-hover:text-gray-300 transition-colors duration-300"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
